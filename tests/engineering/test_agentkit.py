...
class AgentKitMappingTests(unittest.TestCase):
    ...
    def test_representative_runtime_paths_have_precise_owners(self) -> None:
        expected = {
            ...
            "src/imagent/interaction/client_tools/send.py": {"interaction-client-tools"},
            "src/imagent/gateway/__init__.py": {"gateway"},
            "src/imagent/gateway/orchestration.py": {"gateway"},
            "src/imagent/gateway/composition.py": {"gateway"},
            "src/imagent/gateway/input/content_transformation.py": {"gateway"},
            "src/imagent/gateway/input/dispatch.py": {"gateway"},
            ...
            "src/imagent/gateway/projection/observation.py": {"projections-and-recovery"},
            ...
            "src/imagent/gateway/persistence/sqlite.py": {"persistence"},
    ...
    def test_representative_tests_route_to_their_component(self) -> None:
        expected = {
            ...
            "tests/gateway/projection/test_observation.py": {"projections-and-recovery"},
