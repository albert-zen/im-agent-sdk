...
class AgentKitMappingTests(unittest.TestCase):
    def test_representative_runtime_paths_have_precise_owners(self) -> None:
        expected = {
            ...
            "src/imagent/controllers/slash.py": {"controllers"},
            "src/imagent/channels/runtime.py": {"channel-adapters"},
            "src/imagent/channels/native/qq.py": {"channel-adapters"},
    ...
    def test_representative_tests_route_to_their_component(self) -> None:
        expected = {
            ...
            "tests/test_delivery_planning.py": {"delivery-planning-and-coordination"},
