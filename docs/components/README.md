...
[admission](gateway/admission/design.md),
[concurrency](gateway/concurrency/design.md), and
[input](gateway/input/README.md) and
[diagnostics](gateway/diagnostics/design.md) leaves, plus the
