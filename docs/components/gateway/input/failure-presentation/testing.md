...
- exact `MissingBindingError` and `StaleBindingError` preservation as
  `pre_acceptance`, including no binding, route/worker, Application
  resource/input, or fallback delivery mutation;
