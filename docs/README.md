...
| Gateway package root (`gateway/__init__.py`) and `gateway/routing/operations.py` | [gateway design](components/gateway/design.md), [Gateway operations design](components/gateway/routing/gateway-operations/design.md), [testing](components/gateway/routing/gateway-operations/testing.md) | focused Gateway-operation tests plus gateway operation and vertical-slice tests |
