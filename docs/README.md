...
| `gateway/persistence/repository_contracts.py`, `gateway/persistence/memory.py`, `gateway/persistence/row_mapping.py`, `sqlite_rows.py`, `storage.py` | [Gateway persistence](components/gateway/persistence/README.md), [persistence design](components/persistence/design.md), [testing](components/persistence/testing.md), [row-mapping design](components/gateway/persistence/row-mapping/design.md) | Gateway persistence memory, row-mapping, and storage tests |
