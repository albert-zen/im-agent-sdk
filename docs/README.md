...
| `gateway/input/content_transformation.py`, `inbound_failures.py`, and native input dispatch | [Gateway input subtree](components/gateway/input/README.md) and the affected leaf design/testing docs | I1 replay/identity, dispatch fence/correlation, or I2 phase/claim tests |
