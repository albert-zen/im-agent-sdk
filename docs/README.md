...
| `interaction/diagnostics.py`, Channel diagnostic providers, and the transition facade | [Interaction diagnostics design](components/interaction/diagnostics/design.md), [Channel diagnostics design](components/interaction/channels/diagnostics/design.md), and [transition diagnostics](components/diagnostics/design.md) | redaction, bounded-cardinality, reconnect/overflow, identity, and aggregate health tests |
