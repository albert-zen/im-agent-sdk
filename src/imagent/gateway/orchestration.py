"""Private owner of the one Gateway bridge orchestration runtime."""
...
class _GatewayRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        from .routing.operations import _GatewayOperationRuntime

        self._gateway_operations = _GatewayOperationRuntime(
            delegates=self,
    ...
    async def execute_application(
        self,
        operation: _RuntimeApplicationOperation,
    ) -> ApplicationOperationResult:
